 ...
 */
  ...
  $dir = __DIR__;
  $urlApp = "/2DAM_DW_25-26/Artean-2Versiones/ArteanV1/";
...
<head>
    ...
    <link rel="stylesheet" href="<?= $urlApp ?>assets/css/bootstrap.min.css">
...
?>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand" href="<?= $urlApp ?>index.php">Artean</a>

        <div class="collapse navbar-collapse" id="navbarToggler">
            <ul class="navbar-nav mr-auto mt-2 mt-md-0">
                <li class="nav-item">
                    <a class="nav-link" href="<?= $urlApp ?>app/logout.php">Salir</a>
                </li>
            </ul>
        </div>
    </nav>
  ...
  ?>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarToggler">
            <ul class="navbar-nav mr-auto mt-2 mt-md-0">
                <li class="nav-item">
                    <a class="nav-link" href="<?= $urlApp ?>app/signup.php">Registrarse</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $urlApp ?>app/login.php">Entrar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $urlApp ?>app/logout.php">Salir</a>
                </li>
